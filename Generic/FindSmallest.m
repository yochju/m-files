function mask = FindSmallest(M,k)
%% Finds the k smallest elements in the given array.
%
% mask = FindSmallest(M,k)
%
...
% mask = FindSmallest(M,k);
%
% See also FindLargest, FindAbsSmallest, FindAbsLargest
...
% Last revision: 2013-07-05 16:47
