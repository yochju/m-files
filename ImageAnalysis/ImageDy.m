function out = ImageDy(in, varargin)
%% Computes the image derivative in y-direction.
%
% out = ImageDy(in, varargin)
%
...
% Output parameters
%
% out : Image y-derivative of input image in.
%
% Description:
%
% The function computes the derivative in y-direction of an image (the origin
...
% Iy = ImageDy(I,options);
%
% which is equivalent to:
%
% Iy = ImageDx(I,'scheme','scharr','gridSize',[0.5 0.5]);
%
% See also ImageDxx, ImageDx, ImageDyy, ImageDxy, filter2, imfilter.
...
switch opts.scheme
    ...
    case 'forward'
        out = filter2( [0 0 0 ; 0 -1 0 ; 0 1 0]/hy, ...
           out, 'valid' );
    
    case 'backward'
        out = filter2( [0 -1 0 ; 0 1 0 ; 0 0 0]/hy, ...
            out, 'valid' );
    
    case 'central'
        out = filter2( [0 -1 0 ; 0 0 0 ; 0 1 0]/(2*hy), ...
            out, 'valid' );
    
    case 'central-4'
        out = filter2( [0 1 0 ; 0 -8 0 ; 0 0 0 ; 0 8 0 ; 0 -1 0]/(12*hy), ...
            out, 'valid' );
    
    case 'sobel'
        out = filter2( [-1 -2 -1 ; 0 0 0 ; 1 2 1]/(8*hy), ...
            out, 'valid' );
    
    case 'scharr'
        out = filter2( [-3 -10 -3 ; 0 0 0 ; 3 10 3]/(32*hy), ...
            out, 'valid' );
