function out = ImageDyy(in, varargin)
%% Computes the second image derivative in y-direction.
%
% out = ImageDyy(in, varargin)
%
...
% Output parameters
%
% out : Second Image y-derivative of input image in.
%
% Description:
%
% The function computes the second derivative in y-direction of an image (the
...
% Iyy = ImageDyy(Iyy);
%
% See also ImageDx, ImageDy, ImageDxx, ImageDxy, filter2, imfilter.
...
switch opts.scheme
    ...
    case 'standard'
        out = filter2( [0 1 0 ; 0 -2 0 ; 0 1 0]/hy^2, ...
            out, 'valid' );
        
    case 'standard-4'
        out = filter2( [0 -1 0 ; 0 16 0 ; 0 -30 0 ; 0 16 0 ; 0 -1 0]/ ...
            (12*hy^2), out, 'valid' );
