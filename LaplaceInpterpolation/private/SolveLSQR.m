function u = SolveLSQR(in)
%% Solves Laplace Interpolation with the MATLAB lsqr function.
%
% u = SolveLSQR(in)
%
...
% builtin lsqr function. This function should not be used by itself, rather call
