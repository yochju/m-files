...
parser.addParamValue('knotsR', @(x) validateattributes(x, {'numeric'}, ...
    {'vector', 'integer'}, mfilename, 'knotsR'));

parser.addParamValue('knotsC', @(x) validateattributes(x, {'numeric'}, ...
    {'vector', 'integer'}, mfilename, 'knotsC'));
