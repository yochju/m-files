function uk = bregman11( A , b , lambda , C , f , mu , iterout , iterin, iterout2, iterin2 )
% Performs Bregman iteration with two 1-norm terms.
%
% Computes the minimum of
% ||Ax+b||_1 + lambda* ||Cx+f||_1
...
for i=1:iterout
    for j=1:iterin
        uk = bregman12( lambda*C, lambda*f, mu, A, bk-dk, mu, iterout2 , iterin2 );
